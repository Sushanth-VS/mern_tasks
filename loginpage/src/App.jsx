  ...
  return (
    ...
    <div className='bg-slate-200 flex flex-col justify-center rounded-xl items-center min-h-screen'>
      ...
      <div className={`bg-[#FFF] ${switchLayout?"hidden":"grid"} h-[30rem] w-[50rem] rounded-xl grid grid-cols-2 shadow-lg mt-4`}>
         <div className='bg-lime-700 grid grid-col justify-center items-center text-center p-8 rounded-xl'>
         ...
         <div className='flex flex-col p-[2.5rem] gap-4 items-center'>
          ...
          <form className="max-w-md mx-auto">
            ...
            <button type="submit" className="text-white bg-lime-700 hover:bg-lime-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Submit</button>
          </form>
      ...
      <div className={`bg-[#FFF] ${!switchLayout?"hidden":"grid"} h-[30rem] w-[50rem] rounded-xl grid grid-cols-2 shadow-lg mt-4`}>
         ...
         <div className=' bg-lime-700 grid grid-col rounded-xl gap-4 justify-center items-center text-center p-8'>
