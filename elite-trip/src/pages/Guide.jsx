...
function Guide() {
  return (
    <>
    <div className='guide-top' id="Guide">
        <h1>
        Meet your Certified, Experienced, and Professional Travel Guide who will Take You to Your ideal destination.
        </h1>
        <p>
        View additional details by selecting the profile card.
        </p>
    </div>
